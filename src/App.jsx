...
const AdminBillingPage = lazyWithRetry(() => import('./components/admin/BillingPage.jsx'), 'admin-billing')

const PRIORITY_ORDER = { Alta: 3, Media: 2, Baixa: 1, 'Média': 2 }
const APP_TABS = new Set(['dashboard', 'tarefas', 'atividades', 'financas', 'time', 'clientes', 'arquivo', 'calendario', 'tutoriais', 'settings', 'admin-dashboard', 'admin-tenants', 'admin-audit', 'admin-billing'])
...
const TAB_LOADING_LABELS = {
  ...
  'admin-billing': 'Carregando faturamento...',
}
